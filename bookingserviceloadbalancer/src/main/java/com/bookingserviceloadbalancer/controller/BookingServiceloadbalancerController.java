...
@RestController
public class BookingServiceloadbalancerController {
	...
	@CircuitBreaker(name="backup",fallbackMethod="fallbackGetBookings")
	...
	public String getBookings() {
		...
		RoundRobinLoadBalancer lb = clientFactory
				.getInstance("APPLICATION-BOOKING",RoundRobinLoadBalancer.class);
		...
		String url = "http://"+host+":"+port+"/getBookings";
	...
	public String getById(@PathVariable int id) {
		...
		String url = "http://"+host+":"+port+"/getBookingById/"+id;
		System.out.println(url);
		String response = restTemplate.getForObject(url, String.class);
		return response;
	}
	...
	public String getPassengers() {
		...
		String url = "http://"+host+":"+port+"/getPassengers";
		System.out.println(url);
		String response = restTemplate.getForObject(url, String.class);
		return response;
	...
	@PostMapping("/Book")
	public String bookTicket(@RequestBody Booking order) {
		RoundRobinLoadBalancer lb = clientFactory
				.getInstance("APPLICATION-BOOKING",RoundRobinLoadBalancer.class);
		...
		String host = instance.getHost();
		int port = instance.getPort();
		String url = "http://"+host+":"+port+"/Book";
		System.out.println(url);
	...
	public String fallbackGetBookings(CallNotPermittedException ex) {
